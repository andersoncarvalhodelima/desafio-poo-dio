...
import br.com.dio.desafio.dominio.SistemaDeRanking;

import java.time.LocalDate;

public class Main {
    public static void main(String[] args) {
        SistemaDeRanking sistema = new SistemaDeRanking();
        ...
        sistema.cadastrarDev(devCamila);
        ...
        devCamila.exibirCertificado(bootcamp);
        ...
        sistema.cadastrarDev(devAnderson);
        ...
        devAnderson.exibirCertificado(bootcamp);

        System.out.println("-------");
        sistema.exibirRanking();;
